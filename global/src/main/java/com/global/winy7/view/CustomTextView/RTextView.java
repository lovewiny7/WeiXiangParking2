package com.global.winy7.view.CustomTextView;
...
public class RTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public RTextView setIconNormal(int icon) {
        this.mIconNormal = getResources().getDrawable(icon);
        this.mIcon = getResources().getDrawable(icon);
        setIcon();
        return this;
    }
     ...
     * 空的Icon
     */
    public RTextView setIconNormalNull() {
//        this.mIconNormal = icon;
//        this.mIcon = icon;
