...
public class UserUtil {
    ...
    public static String getUserToken() {
        String token = PreferencesManager.getInstance(BaseApplication.getAppContext())
                .get(AppConfig.PREF_USER_TOKEN, "asdfadfadfadfaasdfasdfasdf");
        return token;
    }
    ...
    public static String getParkingLotId() {
        String parkingLotId = PreferencesManager.getInstance(BaseApplication.getAppContext())
                .get(AppConfig.PREF_PARKING_LOT_ID, "");
        return parkingLotId;
    }
...
//        String date = PreferencesManager.getInstance(BaseApplication.getAppContext()).get("date", "");
