...
public class ItemGridViewCreateGeneralRequestBinding extends android.databinding.ViewDataBinding  {
    ...
    public ItemGridViewCreateGeneralRequestBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
    ...
    public static ItemGridViewCreateGeneralRequestBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemGridViewCreateGeneralRequestBinding>inflate(inflater, com.global.R.layout.item_grid_view_create_general_request, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemGridViewCreateGeneralRequestBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.global.R.layout.item_grid_view_create_general_request, null, false), bindingComponent);
    }
    @NonNull
    ...
    public static ItemGridViewCreateGeneralRequestBinding bind(@NonNull android.view.View view, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        if (!"layout/item_grid_view_create_general_request_0".equals(view.getTag())) {
            throw new RuntimeException("view tag isn't correct on view:" + view.getTag());
        }
        return new ItemGridViewCreateGeneralRequestBinding(bindingComponent, view);
    }
    /* flag mapping
        flag 0 (0x1L): click
