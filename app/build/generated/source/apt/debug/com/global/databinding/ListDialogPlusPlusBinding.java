...
public class ListDialogPlusPlusBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_commit, 2);
    ...
    public ListDialogPlusPlusBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        super(bindingComponent, root, 0);
        final Object[] bindings = mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds);
        this.mboundView0 = (android.widget.LinearLayout) bindings[0];
        this.mboundView0.setTag(null);
        this.recyclerview = (android.support.v7.widget.RecyclerView) bindings[3];
        this.tvCommit = (android.widget.TextView) bindings[2];
    ...
    public static ListDialogPlusPlusBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ListDialogPlusPlusBinding>inflate(inflater, com.global.R.layout.list_dialog_plus_plus, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ListDialogPlusPlusBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.global.R.layout.list_dialog_plus_plus, null, false), bindingComponent);
    }
    @NonNull
    ...
    public static ListDialogPlusPlusBinding bind(@NonNull android.view.View view, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        if (!"layout/list_dialog_plus_plus_0".equals(view.getTag())) {
            throw new RuntimeException("view tag isn't correct on view:" + view.getTag());
        }
        return new ListDialogPlusPlusBinding(bindingComponent, view);
    }
    /* flag mapping
        flag 0 (0x1L): title
        flag 1 (0x2L): null
