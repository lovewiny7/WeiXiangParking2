...
public abstract class BaseProgressAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> implements LoadMore {
     ...
     *         数据集合
     */
    public void setData(@Nullable List<? extends T> data,float max) {
        //mData.clear();
        //if (data != null){
        //    mData.addAll(data);
        //}
     ...
     *         数据集合
     */
    public void addData(List<? extends T> data,float max) {
        mMaxProgress = max;
        if (data == null) {
            return;
        }
    ...
    public final void onBindViewHolder(BaseViewHolder holder, int position) {
        ...
        if (index < mData.size()) {
            ...
            convert(holder, data, index,mMaxProgress);
            return;
        }
     ...
     */
    public abstract void convert(BaseViewHolder holder, T data, int index,float mMaxProgress);
